 ...
 */
export declare const FrequencyResponseCurve: ({ magnitudes, dotted, color, opacity, lineWidth, gradientId, className, style, animate, easing, duration }: FrequencyResponseCurveProps) => import("react").JSX.Element;
