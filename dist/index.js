import React, { createContext, forwardRef, useCallback, useContext, useEffect, useId, useImperativeHandle, useLayoutEffect, useMemo, useRef, useState } from "react";
...
var GraphContext = createContext(void 0);
var GraphProvider = ({ children, svgRef, scale, logScale, height, width, outerHeight, outerWidth, theme, padding, clipPathId }) => {
	...
	return /* @__PURE__ */ jsx(GraphContext.Provider, {
		value: contextValue,
		children
	});
};
...
var GraphGradient = () => {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		...
		Boolean(borderWidth) && /* @__PURE__ */ jsx("rect", {
			x: borderWidth / 2,
			y: borderWidth / 2,
...
var CompositeCurve = ({ filters, resolutionFactor = 2, color, dotted, opacity, lineWidth, gradientId, style, easing, animate, duration, className }) => {
	...
	const memoizedGetFilterKey = useCallback((filter) => {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("use", { href: "#centerLine" }), /* @__PURE__ */ jsx(FrequencyResponseCurve, {
	...
	return /* @__PURE__ */ jsxs("g", {
		...
		children: [
			dBs.map((tick, index) => {
				...
				return /* @__PURE__ */ jsxs(React.Fragment, { children: [/* @__PURE__ */ jsx("line", {
					x1: "0",
					x2: width,
					y1: tickY,
					y2: tickY,
			...
			showDbUnitLabel !== false && dbLabels && /* @__PURE__ */ jsx("text", {
				y: unitLabelY,
				x: gainLabelX,
				fill: labelColor,
				fontSize,
...
*/
var FrequencyResponseGraph = forwardRef((props, forwardedRef) => {
	const ref = useRef(null);
	useImperativeHandle(forwardedRef, () => ref.current);
	const { width, height, scale, theme, style = {}, className = "", ariaLabel = "Frequency response graph", children } = props;
	const mergedTheme = useMemo(() => (0, import_cjs.default)(defaultTheme, theme ?? {}), [theme]);
	const mergedScale = useMemo(() => (0, import_cjs.default)(defaultScale, scale ?? {}, { arrayMerge: (_, source) => source }), [scale]);
  ...
  #${graphId} * {
	...
	return /* @__PURE__ */ jsxs("svg", {
		...
		children: [/* @__PURE__ */ jsxs("defs", { children: [/* @__PURE__ */ jsx("style", { children: resetStyles }), /* @__PURE__ */ jsx("clipPath", {
			id: clipPathId,
...
var GraphInputGrid = () => {
	...
	return /* @__PURE__ */ jsxs("g", {
		...
		}), inputMin <= 0 && inputMax >= 0 && /* @__PURE__ */ jsx("line", {
			x1: logScale.x(0),
			x2: logScale.x(0),
			y1: "0",
			y2: height,
...
*/
var DRCGraph = forwardRef((props, forwardedRef) => {
	const ref = useRef(null);
	useImperativeHandle(forwardedRef, () => ref.current);
...
var DRCCurve = ({ threshold, ratio, knee = 0, makeup = 0, attack, release, inputMin, inputMax, resolutionFactor = 2, ...curveProps }) => {
	...
	const magnitudes = useMemo(() => calcDrcMagnitudes({
		threshold,
		ratio,
		knee,
		makeup,
	...
	return /* @__PURE__ */ jsx(FrequencyResponseCurve, {
		magnitudes,
		...curveProps
	});
};
...
var FilterCurve = ({ filter, index = -1, resolutionFactor = 2, color, dotted, opacity, lineWidth, gradientId, showPin = false, showBypass = false, active = false, activeColor, activeOpacity, activeLineWidth, style, easing, animate, duration, className, onChange }) => {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [showPin && /* @__PURE__ */ jsx(FilterPin, {
		vars,
		filter,
		color: curveColor,
		opacity: curveOpacity,
		lineWidth: curveWidth
	}), /* @__PURE__ */ jsx(FrequencyResponseCurve, {
		magnitudes,
		dotted,
		color: curveColor,
		opacity: curveOpacity,
...
var FilterPin = ({ filter, vars, opacity, lineWidth, color }) => {
	...
	if (gain < 0 && deltaX || gain >= 0 && !deltaX || pass2UpFlag) return /* @__PURE__ */ jsx("line", {
		x1: x,
		x2: x,
		y1: pointY,
		y2: magnitudeY,
...
var BypassIcon = (props) => /* @__PURE__ */ jsx(FilterIcon, {
	...props,
	type: "BYPASS"
});
var LowPassIcon = (props) => /* @__PURE__ */ jsx(FilterIcon, {
	...props,
	type: "LOWPASS2"
});
var HighPassIcon = (props) => /* @__PURE__ */ jsx(FilterIcon, {
	...props,
	type: "HIGHPASS2"
});
var LowShelfIcon = (props) => /* @__PURE__ */ jsx(FilterIcon, {
	...props,
	type: "LOWSHELF2"
});
var HighShelfIcon = (props) => /* @__PURE__ */ jsx(FilterIcon, {
	...props,
	type: "HIGHSHELF2"
});
var BandPassIcon = (props) => /* @__PURE__ */ jsx(FilterIcon, {
	...props,
	type: "BANDPASS"
});
var NotchIcon = (props) => /* @__PURE__ */ jsx(FilterIcon, {
	...props,
	type: "NOTCH"
});
var PeakIcon = (props) => /* @__PURE__ */ jsx(FilterIcon, {
	...props,
	type: "PEAK"
});
var GainIcon = (props) => /* @__PURE__ */ jsx(FilterIcon, {
	...props,
	type: "GAIN"
});
//#endregion
...
var FilterPoint = ({ filter, index = -1, dragX = true, dragY = true, wheelQ = true, minQ, maxQ, gainPrecision, qPrecision, active = false, showIcon = false, label = "", labelFontSize, labelFontFamily, labelColor, radius, lineWidth, color, zeroColor, dragColor, activeColor, background, zeroBackground, dragBackground, activeBackground, backgroundOpacity, dragBackgroundOpacity, activeBackgroundOpacity, className, style, onChange, onEnter, onLeave, onDoubleClick, onDrag }) => {
	...
	return /* @__PURE__ */ jsxs("g", {
		...
		children: [/* @__PURE__ */ jsx("circle", {
			...
			className
		}), Boolean(label) && /* @__PURE__ */ jsx("text", {
			ref: labelRef,
			"aria-hidden": "true",
			x,
			y,
