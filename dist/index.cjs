...
const GraphInputGrid = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    inputMin <= 0 && inputMax >= 0 && /* @__PURE__ */ jsxRuntime.jsx(
      "line",
      {
        x1: logScale.x(0),
        x2: logScale.x(0),
...
const DRCGraph = React.forwardRef(
  (props, forwardedRef) => {
    const ref = React.useRef(null);
    React.useImperativeHandle(forwardedRef, () => ref.current);
    const {
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            GraphProvider,
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsxs("g", { transform: graphTransform, children: [
                /* @__PURE__ */ jsxRuntime.jsx(GraphGradient, {}),
                /* @__PURE__ */ jsxRuntime.jsx(GraphGainGrid, {}),
                /* @__PURE__ */ jsxRuntime.jsx(GraphInputGrid, {}),
                children
              ] })
            }
          )
...
const DRCCurve = ({
  ...
  const magnitudes = React.useMemo(
    () => calcDrcMagnitudes({
      threshold,
      ratio,
      knee,
...
const FilterPoint = ({
  ...
  const [zeroGain, passFilter, zeroQ] = React.useMemo(
    () => [
      getZeroGain(type),
